                            ...
                            children: [
                              Expanded(
                                ...
                                child: SfCartesianChart(
                                    ...
                                    title: ChartTitle(
                                        text:
                                            'Báo cáo số lượng sinh viên theo $text'),
                                    // Enable legend
                                    legend: Legend(isVisible: true),
                                    // Enable tooltip
                                    tooltipBehavior:
                                        TooltipBehavior(enable: true),
                                    series: <ChartSeries<GetReportStudentOtd,
                                        String>>[
                            ...
                            children: [
                              Expanded(
                                ...
                                child: SfCartesianChart(
                                    ...
                                    // Chart title
                                    title: ChartTitle(
                                        text: 'Báo cáo tổng thu theo $text1'),
                                    // Enable legend
                                    legend: Legend(isVisible: true),
                                    // Enable tooltip
                                    tooltipBehavior:
                                        TooltipBehavior(enable: true),
                                    series: <ChartSeries<GetReportPaymenttd,
                                        String>>[
                                      LineSeries<GetReportPaymenttd, String>(
                                          dataSource: data1,
                                          xValueMapper:
                                              (GetReportPaymenttd sales, _) =>
                                                  sales.title,
                                          yValueMapper:
                                              (GetReportPaymenttd sales, _) =>
                                                  sales.total,
