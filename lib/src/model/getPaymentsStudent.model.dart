...
List<GetPaymentStudentOtd> getPaymentStudentOtdFromJson(String str) =>
    List<GetPaymentStudentOtd>.from(
        json.decode(str).map((x) => GetPaymentStudentOtd.fromJson(x)));

String getPaymentStudentOtdToJson(List<GetPaymentStudentOtd> data) =>
